# ==============================================================================
# HUB-PC (V2) - TERRAFORM: VARIÁVEIS DO AMBIENTE DEV
...
# Caminho local da chave JSON do sa-terraform-dev — nunca hardcoded aqui.
# ==============================================================================
variable "caminho_chave_sa" {
  description = "Caminho absoluto para a chave JSON da conta de serviço sa-terraform-dev"
  type        = string
